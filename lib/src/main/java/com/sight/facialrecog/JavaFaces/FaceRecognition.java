...
{
  private static final float FACES_FRAC = 0.9f;   
  ...
  private int numEFs = 7;     // number of eigenfaces to be used in the recognition
  ...
  {
    if (bundle == null) {
      JOptionPane.showMessageDialog(null, "You must build an Eigenfaces cache before any matching");
      return null;
    }
